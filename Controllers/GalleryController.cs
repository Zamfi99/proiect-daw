...
namespace DAW_Yacht.Controllers
{
    public class GalleryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdYacht")] GalleryModel galleryModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdYacht")] GalleryModel galleryModel)
        {
